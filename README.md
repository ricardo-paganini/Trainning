...
[Exercício1](exercicio1.py)
Crie um programa que verifique se um número é par ou ímpar.

[Exercício2](exercicio2.py)
Crie um programa que verifica se um número digitado pelo usuário é positivo, negativo ou zero.

[Exercício3](exercicio3.py)
Crie um programa que verifica se uma letra digitada pelo usuário é vogal ou consoante.
